...
namespace gasolinera_json
{
    public partial class Diesel : Form
    {
        ...
        private int TanqueLlenoDiesel { get; set; }
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            TanqueLlenoDiesel = 1;
            EnviarComando(new { action = "LlenoDiesel" });
        ...
        {
            EnviarComando(new { action = "Apagar3" });
        }
        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                this.Invoke(new Action(() =>
                {
                    ...
                    if (message.Contains("Motor detenido3"))
                    {
                        DetenerTimers();
                        ApagarMotor();
